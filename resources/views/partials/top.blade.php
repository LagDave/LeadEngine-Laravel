...
<head>
    ...
    {{-- Remote Assets --}}
        ...
        {{-- Barlow|Montserrat|Poppins|Wire One --}}
        <link href="https://fonts.googleapis.com/css?family=Barlow+Condensed:700|Montserrat|Poppins|Wire+One"
              rel="stylesheet">
        {{-- Roboto --}}
    ...
    <link rel="stylesheet" href="{{asset('css/free-consultation.css')}}">
