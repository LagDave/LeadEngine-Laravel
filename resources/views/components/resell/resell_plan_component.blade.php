        ...
        <div class="pricing">
                <div class="pricing-wrapper">
                    <div class="price-and-calculator-container">
                        ...
                        <br>
                        <div class='white-label-checkout-container' style='width:100%; display:flex; align-items:center; justify-content:center; transform: scale(1.3, 1.3)'>
                        </div>
                    ...
                    <p style='background:#EF5563; margin:0; border-radius:5px 5px 0 0; padding:10px 0;' class="text-white pricing-title text-mednorm text-primary text-center">PREMIUM</p>
                        ...
                        <br>
                        <div style='width:100%; display:flex; align-items:center; justify-content:center; transform: scale(1.3, 1.3)'>
                            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                <input type="hidden" name="cmd" value="_s-xclick">
                                <input type="hidden" name="hosted_button_id" value="PEKHES4L35RZS">
